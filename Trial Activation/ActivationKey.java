    ...
    */
    ...
    try {
      ...
      */
      ...
      String activationkey_startdate = Utility.getPreference(vars, "activationkey_startdate", null);
      if (activationkey_startdate==null||activationkey_startdate.isEmpty())
    	  activationkey_startdate="2011-01-01";
      String activationkey_customer = Utility.getPreference(vars, "activationkey_customer", null);
      if (activationkey_customer==null||activationkey_customer.isEmpty())
    	  activationkey_customer="Cahyo Agung Prastio";
      instanceProperties.setProperty("startdate", activationkey_startdate);
      instanceProperties.setProperty("enddate", "9999-12-31");
      instanceProperties.setProperty("purpose", "P");
      instanceProperties.setProperty("trial", "false");
      instanceProperties.setProperty("limitusers", "999");
      instanceProperties.setProperty("limituserswarn", "999");
      instanceProperties.setProperty("customer", activationkey_customer);
      instanceProperties.setProperty("wsPacks", "500");
      instanceProperties.setProperty("wsUnitsPerUnit", "500");
      instanceProperties.setProperty("lincensetype", "USR");
      instanceProperties.setProperty("instanceno", "1");
